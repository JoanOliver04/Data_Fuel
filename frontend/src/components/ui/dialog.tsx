  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-2xl border border-border bg-popover text-popover-foreground p-6 shadow-elevation-xl",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          "absolute right-4 top-4 rounded-full p-1 opacity-60 transition-opacity",
